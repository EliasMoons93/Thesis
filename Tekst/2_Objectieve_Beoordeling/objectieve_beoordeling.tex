...
\end{tikzpicture}
    \centering
    \caption{Neuraal netwerk met 12 input nodes (1 voor elke noot), 6 hidden nodes en 1 output.}
    \label{figuur:ANN}
\end{figure}
